...
%%%%%%%%%%%%%%%
%
% small average thickness shouldn't matter, but small variability in
% thickness does, is this what you meant to say?
...
%%%%%%%%%%%%%%%
%
% These equations need equation numbers and the text connecting them needs to
% properly introduce each equation. (He just means provide numbers /references)
...
%%%%%%%%%%%%%%%
%
% We aren't exactly measuring deviation from uniform thickness, though when
% that happens, CMC should shift.
%
% this should become: .....deviation from volumetric expectation for a simple
% structure. (or something like that, also cut the second half of the
% sentence "where the region......")
...
%%%%%%%%%%%%%%%
%
% THis table (tab:lateral-fs) is a mess. Please cut it out. Please summarize
% the FS features here (there is are surface area, volume, cortical thickness
% variability, etc. for each cortical ROI)
...
%%%%%%%%%%%%%%%
%
% I dont see these (above) results and there is no table referred to here.
% This sounds like it will be very boring and can be removed.
...
%%%%%%%%%%%%%%%
%
% What do you mean by synthetic?? These are real phenotypic targets aren't
% they?, so the word synthetic might mislead the reader.
...
%%%%%%%%%%%%%%%
%
% This [table above] is really boring and doesn't add much. It doesn't tell
% us anything about CMC, so can be cut.
...
%%%%%%%%%%%%%%%
%
% This [above] isn't easy to follow at all
...
%%%%%%%%%%%%%%%
%
% Please insert the correct values for these regions
